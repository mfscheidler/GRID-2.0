...
public interface GRIDweight {
	// defaults
    public double tierOne = 4.166666666666667;         // 760 G/Mi
    public double tierTwo = 5.555555555555555;        // 450 G/Mi
    public double tierThree = 8.333333333333334;      // 360 G/Mi
    ...
    double calcWeight(String fromNode, String toNode, long startTime, double speedModifier);
}
